...
class DoomRandom {
  ...
  int get rndIndex => _rndIndex;
  int get prndIndex => _prndIndex;

  set rndIndex(int value) => _rndIndex = value & 0xff;
  set prndIndex(int value) => _prndIndex = value & 0xff;
}
